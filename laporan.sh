...
hledger bal -f "$JOURNAL_FILE" > laporan/balance.html

# 2. Laporan Laba Rugi (Income Statement)
hledger is -f "$JOURNAL_FILE" > laporan/income.html

# 3. Laporan Arus Kas (Cash Flow)
hledger cf -f "$JOURNAL_FILE" > laporan/cashflow.html

# 4. Laporan Register (Semua Transaksi)
hledger reg -f "$JOURNAL_FILE" > laporan/register.html
